    ...
    <div className="i">
      <div className="i-left">
        <div className="i-left-wrapper">
          ...
          <h1 className="i-name">Isaac E. Warri</h1>
          ...
          <p className="i-desc">
            I solve problems with React/Native and Wordpress, helping 
            individual and corporate organisations to design, maintain, and 
